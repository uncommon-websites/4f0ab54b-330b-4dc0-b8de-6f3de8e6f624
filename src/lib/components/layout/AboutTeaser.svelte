...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Leo Radloff",
		role: "Founder",
		image: "/generated/image-professional-business-portrait-of-a-thou.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I was tired of spending entire afternoons nudging boxes in PowerPoint just to create one clean slide. So we built Slides—to think like a designer, so you don't have to."`}
			/>
